...
final ppobBrandsProvider = FutureProvider.autoDispose.family<List<PPOBBrandModel>, String>((ref, category) async {
  final service = ref.watch(ppobServiceProvider);
  return service.getBrands(category: category);
});

class PulsaBrandPage extends ConsumerWidget {
  const PulsaBrandPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final brandsAsync = ref.watch(ppobBrandsProvider('pulsa'));
          ...
          return GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                onTap: () {
                  context.push('${AppRoutes.pulsaForm}?brand=${Uri.encodeComponent(brand.name)}');
                },
                child: Column(
                  children: [
                    Expanded(
