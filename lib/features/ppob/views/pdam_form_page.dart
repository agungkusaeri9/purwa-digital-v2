...
import '../viewmodels/pdam_form_viewmodel.dart';
...
class PdamFormPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PdamFormPage> createState() => _PdamFormPageState();
}

class _PdamFormPageState extends ConsumerState<PdamFormPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(pdamFormViewModelProvider.notifier).init(
  ...
  void _showConfirmationSheet(BuildContext context) {
    final viewModel = ref.read(pdamFormViewModelProvider.notifier);
    final state = ref.read(pdamFormViewModelProvider);
    ...
    showModalBottomSheet(
      ...
      builder: (sheetContext) {
        return PPOBConfirmationSheet(
          ...
          provider: state.pdamName.toUpperCase(),
          productLabel: 'Nama Pelanggan PDAM',
  ...
  Widget build(BuildContext context) {
    final state = ref.watch(pdamFormViewModelProvider);
    final viewModel = ref.read(pdamFormViewModelProvider.notifier);
    const primaryColor = Color(0xff06B6D4);

    ref.listen<String?>(
      pdamFormViewModelProvider.select((s) => s.errorMessage),
      (prev, next) {
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  // 1. Input No. Pelanggan PDAM Card
                  Container(
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                'Nomor Pelanggan ${state.pdamName}',
                                style: const TextStyle(
                                  fontSize: 13,
                                  fontWeight: FontWeight.bold,
                                  color: Color(0xff0F172A),
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(
                            hintText: 'Masukkan Nomor Pelanggan / ID PDAM',
                            hintStyle: TextStyle(
                  ...
                  if (inquiry != null) ...[
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          _buildDetailRow('Layanan', state.pdamName),
